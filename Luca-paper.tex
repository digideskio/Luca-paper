...
Search and rescue, autonomous construction, and many other multi-robot semi-autonomous robotics applications can benefit from an efficient human control over a group of robots. 
...
Our results show that despite the numerous artifacts, it is possible to guarantee, on average, a recognition rate of 75\% at any time after the first four seconds of the EEG data acquisition.
