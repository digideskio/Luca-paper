...
\title{Electroencephalography as a proximal human interaction method with a group of robots}
...
\label{sec:soa}
% PAPA: il faut serieusement un truc aussi general et qui va dans tous les sens??
...
% PAPA: je comprends pas: "a study" ca veut dire qu'on l'a fait nous ou est-ce qu'il manque une citation?
...
% PAPA: est-ce qu'il faut mettre ca?
...
\\
% PAPA: C'est un peu redondant ce passage. C'est grave ou pas? Je n'est pas trouve comment resoudre cette redondance sans changer toute la structure du texte
...
% PAPA: est-ce que ca, ca veut dire que les retards sont similaires aux autres scenarios ou est-ce que ca veut dire que notre scenario pourrait profiter d'un scenario hybride?
This delay can be compared with the delay of gesture recognition or speech interaction when considering the complete time of interaction.
