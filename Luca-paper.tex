...
%\titlerunning{EEG as a proximal human interaction method with a group of robots}% for an abbreviated version of your contribution title if the original one is too long
...
Most of the research on proximal interaction with groups of robots has studied gesture and speech recognition to select the robots among the group or to give orders. 
...
% PAPA: verifie si ca te va le bout qui suit
...
% PAPA: the indeed makes no sense... je comprends pas ce que ca veut dire
% je pense qu'il faut recrire toute la phrase, mais je sais pas exactement comment
Indeed, the frequency of 10\,$Hz$ presents the highest stimuli responses, followed by 16 -- 18\,$Hz$, but BCI interfaces have been built around frequencies spanning from 4.8\,$Hz$ up to 43\,$Hz$.\\
\\
% PAPA: attends attends attends: "could generate excellent results"?!?
...
Based on these observations, we restricted the frequency band in the following two studies; the chosen interval: $[7\,Hz, 17\,Hz]$.
